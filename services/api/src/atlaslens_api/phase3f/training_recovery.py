...
_TYPED_REMOTE_CODES: Final[tuple[tuple[str, str], ...]] = (
    ("REMOTE_TRAINING_CUDA_OOM_BASELINE", "REMOTE_TRAINING_CUDA_OOM_BASELINE"),
    ("REMOTE_TRAINING_CUDA_OOM_TRAIN", "REMOTE_TRAINING_CUDA_OOM_TRAIN"),
    ("REMOTE_TRAINING_CUDA_OOM_VALIDATION", "REMOTE_TRAINING_CUDA_OOM_VALIDATION"),
    ("REMOTE_TRAINING_CUDA_OOM_HOLDOUT", "REMOTE_TRAINING_CUDA_OOM_HOLDOUT"),
    ("REMOTE_TRAINING_CUDA_OOM_BATCH_ONE", "REMOTE_TRAINING_CUDA_OOM_BATCH_ONE"),
    ("TRAINING_CUDA_OOM", "REMOTE_TRAINING_CUDA_OOM"),
    ("CUDA_OUT_OF_MEMORY", "REMOTE_TRAINING_CUDA_OOM"),
    ("TRAINING_DEADLINE_INVALID", "REMOTE_TRAINING_DEADLINE_INVALID"),
